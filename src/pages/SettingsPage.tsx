...
const SettingsPage = () => {
  ...
  const SettingRow = ({ title, description, children }) => (
    <div className={`flex justify-between items-center py-4 border-b last:border-b-0 ${darkMode ? "border-gray-700" : ""}`}>
      <div className="flex flex-col">
        ...
        <span className={`text-sm max-w-lg ${darkMode ? "text-gray-400" : "text-gray-500"}`}>
          {description}
        </span>
      </div>
    ...
    <div className="space-y-6">
      ...
      >
        <button
          ...
          className={`relative inline-flex h-8 w-14 items-center rounded-full ${darkMode ? "bg-indigo-600" : "bg-gray-300"}`}
        >
          <span
      ...
      >
        <div className="flex space-x-2">
          <button
            ...
            className={`px-3 py-1 rounded-md ${fontSize === "small" ? "bg-indigo-500 text-white" : darkMode ? "bg-gray-700 text-gray-300" : "bg-gray-200"
              }`}
          >
            A-
          </button>
          <button
            ...
            className={`px-3 py-1 rounded-md ${fontSize === "medium" ? "bg-indigo-500 text-white" : darkMode ? "bg-gray-700 text-gray-300" : "bg-gray-200"
              }`}
          >
            A
          </button>
          <button
            ...
            className={`px-3 py-1 rounded-md ${fontSize === "large" ? "bg-indigo-500 text-white" : darkMode ? "bg-gray-700 text-gray-300" : "bg-gray-200"
              }`}
          >
            A+
          </button>
  ...
  const SecuritySection = () => (
    <div className="space-y-6">
      ...
      <SettingRow title="Active Sessions" description="See where you are currently logged in.">
  ...
  const SystemConfigSection = () => {
    ...
    return (
      <div className="space-y-6">
        ...
        <SettingRow title="Academic Term Setup" description="Set academic year.">
          <div className="flex items-center space-x-2">
            <Calendar className="h-4 w-4" />
            <input
              value={academicYear}
              onChange={(e) => setAcademicYear(e.target.value)}
              className={`p-1 border rounded ${darkMode ? "bg-gray-700 text-white" : ""}`}
            />
            <button onClick={() => showSuccess("Academic year updated")} className="text-indigo-600">
              Update
            </button>
          </div>
        </SettingRow>
  ...
  const DataMaintenanceSection = () => (
    <div className="space-y-6">
      ...
      <SettingRow
        ...
        description={<span className="text-red-500 font-bold">DANGER ZONE</span>}
      >
  ...
  return (
    <div className={`min-h-screen p-6 font-sans ${fontSizeClass[fontSize]} ${darkMode ? "bg-gray-900 text-white" : "bg-gray-50 text-black"}`}>
          ...
          {navItems
            ...
            .map((item) => (
              <button
                ...
                className={`w-full flex items-center px-4 py-3 rounded-lg mb-1 ${activeSection === item.id ? "bg-indigo-600 text-white" : ""
                  }`}
              >
